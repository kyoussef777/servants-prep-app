                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                          ...
                          <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded p-3 text-center">
                            <div className="text-2xl font-bold text-gray-700 dark:text-gray-300">{analytics.attendance.excusedCount - (analytics.attendance.notEnrolledYetCount ?? 0)}</div>
                            <div className="text-xs text-gray-600 dark:text-gray-400">Excused</div>
                            {(analytics.attendance.notEnrolledYetCount ?? 0) > 0 && (
                              <div className="text-[10px] text-gray-400">+{analytics.attendance.notEnrolledYetCount} N/A</div>
                            )}
                          </div>
